...
export default async function WeeklyPage() {
  const [allPrices, allNews, dailyData, usHistory] = await Promise.all([
    getWeeklyPrices(),
    getWeeklyNews(),
  ...
  return (
    <DashboardLayout title="이노스페이스 주간 주가 및 매매 동향">
      <WeeklyDashboard prices={prices} news={news} innospaceHistory={innospaceHistory} usHistory={usHistory} />
    </DashboardLayout>
  );
}
